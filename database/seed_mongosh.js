...
// Xóa sạch dữ liệu cũ (nếu cần reset hoàn toàn)
db.users.deleteMany({});
...
db.users.insertMany([
  {
    ...
    updatedAt: ISODate("2026-03-12T03:00:00Z"),
  },
  {
    ...
    createdAt: ISODate("2026-03-10T09:00:00Z"),
    updatedAt: ISODate("2026-03-12T04:00:00Z"),
  },
  {
    ...
    updatedAt: ISODate("2026-03-12T05:30:00Z"),
  },
  {
    ...
    createdAt: ISODate("2026-03-11T01:10:00Z"),
    updatedAt: ISODate("2026-03-12T01:00:00Z"),
  },
]);
...
// 3. products (full 8 sản phẩm)
db.products.insertMany([
  {
    _id: ObjectId("65f300000000000000000001"),
    categoryId: ObjectId("65f200000000000000000002"),
    name: "Cây kim tiền",
    slug: "cay-kim-tien",
    sku: "SP001",
    shortDescription: "Cây phong thủy dễ chăm, phù hợp văn phòng.",
    description:
      "Kim tiền có tán lá dày, xanh bóng, tượng trưng cho tài lộc và rất phù hợp để đặt ở phòng khách hoặc bàn làm việc.",
    price: 320000,
    ...
    dimensions: { heightCm: 45, potSizeCm: 18 },
    images: [
      {
  ...
  },
  {
    ...
    dimensions: { heightCm: 30, potSizeCm: 14 },
    images: [
      {
    ...
    attributes: [
      { name: "Màu lá", value: "Xanh viền vàng" },
      { name: "Vị trí", value: "Trong nhà" },
    ],
    isFeatured: true,
    isActive: true,
  ...
  },
  {
    ...
    categoryId: ObjectId("65f200000000000000000005"),
    name: "Trầu bà xanh",
    slug: "trau-ba-xanh",
    sku: "SP003",
    shortDescription: "Cây dây leo mềm mại, phù hợp kệ cao và ban công.",
    description:
      "Trầu bà xanh sinh trưởng nhanh, lá bóng đẹp, dễ chăm và tạo cảm giác tươi mát cho không gian sống.",
    price: 210000,
    ...
    dimensions: { heightCm: 35, potSizeCm: 16 },
    images: [
      {
    ...
    attributes: [
      { name: "Dáng cây", value: "Dây leo" },
      { name: "Vị trí", value: "Trong nhà/Ban công" },
    ],
    isFeatured: false,
    isActive: true,
    createdAt: ISODate("2026-03-10T00:00:00Z"),
  ...
  },
  {
    ...
    categoryId: ObjectId("65f200000000000000000004"),
    name: "Monstera deliciosa",
    slug: "monstera-deliciosa",
    sku: "SP004",
    shortDescription: "Cây lá xẻ nổi bật, hợp không gian hiện đại.",
    description:
      "Monstera là dòng cây nội thất được ưa chuộng nhờ bộ lá xẻ lớn, tạo điểm nhấn mạnh cho phòng khách hoặc studio.",
    price: 690000,
    ...
    dimensions: { heightCm: 75, potSizeCm: 24 },
    images: [
      {
    ...
    attributes: [
      { name: "Kiểu lá", value: "Lá xẻ" },
      { name: "Vị trí", value: "Phòng khách" },
    ],
    isFeatured: true,
    isActive: true,
    createdAt: ISODate("2026-03-10T00:00:00Z"),
  ...
  },
  {
    ...
    categoryId: ObjectId("65f200000000000000000003"),
    name: "Sen đá mix chậu sứ",
    slug: "sen-da-mix-chau-su",
    sku: "SP005",
    shortDescription: "Bộ sen đá nhỏ gọn, tối giản, hợp bàn làm việc.",
    description:
      "Sen đá mix chậu sứ có vẻ ngoài thanh lịch, chịu hạn tốt, ít phải chăm và là lựa chọn quà tặng phổ biến.",
    price: 145000,
    ...
    dimensions: { heightCm: 16, potSizeCm: 10 },
    images: [
      {
    ...
    attributes: [
      { name: "Nhóm cây", value: "Sen đá" },
      { name: "Vị trí", value: "Bàn làm việc" },
    ],
    isFeatured: false,
    isActive: true,
    createdAt: ISODate("2026-03-10T00:00:00Z"),
  ...
  {
    _id: ObjectId("65f300000000000000000006"),
    categoryId: ObjectId("65f200000000000000000003"),
    name: "Nha đam mini",
    slug: "nha-dam-mini",
    sku: "SP006",
    ...
    description:
      "Nha đam mini có phần lá mọng nước, dễ chăm, chịu nắng tốt và thích hợp đặt gần cửa sổ hoặc ban công nhỏ.",
    price: 125000,
    ...
    dimensions: { heightCm: 22, potSizeCm: 11 },
    images: [
      {
    ...
    attributes: [
      { name: "Nhóm cây", value: "Mọng nước" },
      { name: "Vị trí", value: "Cửa sổ/Ban công" },
    ],
    isFeatured: false,
    isActive: true,
    createdAt: ISODate("2026-03-10T00:00:00Z"),
  ...
  {
    _id: ObjectId("65f300000000000000000007"),
    categoryId: ObjectId("65f200000000000000000005"),
    ...
    description:
      "Trầu bà cẩm thạch có màu lá loang sáng đẹp mắt, phù hợp decor phong cách hiện đại và tối giản.",
    price: 260000,
    ...
    dimensions: { heightCm: 30, potSizeCm: 15 },
    images: [
      {
        url: "https://images.unsplash.com/photo-1623325943583-d658515e0889?auto=format&fit=crop&fm=jpg&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&ixlib=rb-4.1.0&q=60&w=3000",
  ...
  {
    _id: ObjectId("65f300000000000000000008"),
    categoryId: ObjectId("65f200000000000000000001"),
    name: "Lan ý để bàn",
    slug: "lan-y-de-ban",
    sku: "SP008",
    ...
    description:
      "Lan ý phù hợp đặt ở bàn làm việc hoặc kệ sách, tạo cảm giác nhẹ nhàng và giúp không gian thêm mát mắt.",
    price: 280000,
    ...
    dimensions: { heightCm: 38, potSizeCm: 16 },
    images: [
      {
    ...
    attributes: [
      { name: "Đặc điểm", value: "Lá bóng xanh" },
      { name: "Vị trí", value: "Trong nhà" },
    ],
    isFeatured: false,
    isActive: true,
...
db.carts.insertMany([
  {
    ...
    userId: ObjectId("65f000000000000000000002"),
    status: "active",
    items: [
      {
        productId: ObjectId("65f300000000000000000001"),
        productName: "Cây kim tiền",
        productImage:
          "https://images.unsplash.com/photo-1632207691143-643e2a9a9361?auto=format&fit=crop&fm=jpg&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&ixlib=rb-4.1.0&q=60&w=3000",
        unitPrice: 285000,
        quantity: 1,
        subtotal: 285000,
      },
      {
        productId: ObjectId("65f300000000000000000005"),
        productName: "Sen đá mix chậu sứ",
        productImage:
          "https://images.unsplash.com/photo-1498251095152-27c0ddd22aae?auto=format&fit=crop&fm=jpg&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&ixlib=rb-4.1.0&q=60&w=3000",
        unitPrice: 129000,
        quantity: 2,
        subtotal: 258000,
      },
    ],
    updatedAt: ISODate("2026-03-12T07:15:00Z"),
  },
  {
    ...
    items: [
      {
        productId: ObjectId("65f300000000000000000003"),
        productName: "Trầu bà xanh",
        productImage:
          "https://images.unsplash.com/photo-1624798762133-9fbf8f209b7b?auto=format&fit=crop&fm=jpg&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&ixlib=rb-4.1.0&q=60&w=3000",
        unitPrice: 185000,
        quantity: 1,
        subtotal: 185000,
      },
      {
        productId: ObjectId("65f300000000000000000002"),
        productName: "Cây lưỡi hổ mini",
        productImage:
          "https://images.unsplash.com/photo-1547306720-ad507f7d4d7b?auto=format&fit=crop&fm=jpg&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&ixlib=rb-4.1.0&q=60&w=3000",
        unitPrice: 165000,
        quantity: 1,
        subtotal: 165000,
      },
    ],
    updatedAt: ISODate("2026-03-12T08:05:00Z"),
  },
]);
...
db.orders.insertMany([
  {
    ...
    orderedAt: ISODate("2026-03-12T02:30:00Z"),
    updatedAt: ISODate("2026-03-12T09:00:00Z"),
  },
  {
    ...
    payment: {
      ...
      paidAt: ISODate("2026-03-11T08:22:00Z"),
    },
    status: "confirmed",
    note: "Gọi trước khi giao",
    orderedAt: ISODate("2026-03-11T08:20:00Z"),
    updatedAt: ISODate("2026-03-12T09:00:00Z"),
  },
  {
    ...
    items: [
      {
        productId: ObjectId("65f300000000000000000004"),
        productName: "Monstera deliciosa",
        productImage:
          "https://images.unsplash.com/photo-1762755647813-017e128a4ba0?auto=format&fit=crop&fm=jpg&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&ixlib=rb-4.1.0&q=60&w=3000",
        unitPrice: 620000,
        quantity: 1,
        subtotal: 620000,
      },
      {
        productId: ObjectId("65f300000000000000000006"),
        productName: "Nha đam mini",
        productImage:
          "https://images.unsplash.com/photo-1547516508-c0b73071d9de?auto=format&fit=crop&fm=jpg&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&ixlib=rb-4.1.0&q=60&w=3000",
        unitPrice: 110000,
        quantity: 1,
        subtotal: 110000,
      },
    ...
    payment: {
      ...
      paidAt: ISODate("2026-03-11T01:10:00Z"),
    },
    status: "shipping",
    note: "Giao buổi tối",
    orderedAt: ISODate("2026-03-11T01:00:00Z"),
    updatedAt: ISODate("2026-03-12T09:00:00Z"),
  },
]);
...
db.blog_posts.insertMany([
  {
    ...
    summary:
      "Một số lưu ý về ánh sáng, nước và vị trí đặt cây kim tiền để cây luôn khỏe đẹp.",
    content:
      "Cây kim tiền phù hợp môi trường trong nhà, nên đặt ở nơi có ánh sáng gián tiếp và tránh tưới quá nhiều. Khi mặt đất khô mới tưới lại để hạn chế úng rễ.",
    thumbnail:
      "https://images.unsplash.com/photo-1570641798336-7696b1de5827?auto=format&fit=crop&fm=jpg&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&ixlib=rb-4.1.0&q=60&w=3000",
    tags: ["chăm sóc cây", "kim tiền", "cây nội thất"],
    viewCount: 220,
    isPublished: true,
    publishedAt: ISODate("2026-03-10T02:00:00Z"),
  },
  {
    _id: ObjectId("65f600000000000000000002"),
    title: "5 vị trí đẹp để đặt monstera trong phòng khách",
    slug: "5-vi-tri-dep-dat-monstera-trong-phong-khach",
    category: {
      id: ObjectId("65f200000000000000000004"),
      name: "Cây cỡ lớn",
    },
    author: {
      id: ObjectId("65f000000000000000000001"),
    ...
    summary:
      "Gợi ý bố trí monstera giúp không gian hiện đại hơn mà vẫn đảm bảo cây phát triển tốt.",
    content:
      "Monstera hợp với góc có ánh sáng tán xạ, cạnh sofa, gần cửa kính hoặc các vị trí tạo điểm nhấn trong không gian mở. Tránh nắng gắt trực tiếp giữa trưa.",
    thumbnail:
      "https://images.unsplash.com/photo-1762755647813-017e128a4ba0?auto=format&fit=crop&fm=jpg&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&ixlib=rb-4.1.0&q=60&w=3000",
    tags: ["monstera", "decor", "phòng khách"],
    viewCount: 176,
    isPublished: true,
    publishedAt: ISODate("2026-03-11T01:30:00Z"),
  },
  {
    _id: ObjectId("65f600000000000000000003"),
    title: "Tưới nước cho sen đá và nha đam như thế nào cho đúng?",
    slug: "tuoi-nuoc-cho-sen-da-va-nha-dam-dung-cach",
    category: {
      id: ObjectId("65f200000000000000000003"),
      name: "Sen đá & xương rồng",
    },
    author: {
      id: ObjectId("65f000000000000000000001"),
    ...
    summary:
      "Phân biệt tần suất tưới của các dòng cây mọng nước để tránh thối rễ.",
    content:
      "Sen đá và nha đam đều chịu hạn tốt nên không cần tưới thường xuyên. Chỉ nên tưới khi giá thể khô, ưu tiên chậu thoát nước tốt và nơi có ánh sáng ổn định.",
    thumbnail:
      "https://images.unsplash.com/photo-1498251095152-27c0ddd22aae?auto=format&fit=crop&fm=jpg&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&ixlib=rb-4.1.0&q=60&w=3000",
    tags: ["sen đá", "nha đam", "tưới nước"],
    viewCount: 143,
    isPublished: true,
    publishedAt: ISODate("2026-03-11T09:15:00Z"),
  },
]);
...
db.stores.insertMany([
  {
    ...
    description:
      "Chuyên cây cảnh nội thất, cây để bàn và phụ kiện trang trí không gian sống.",
    branches: [
      {
...
db.reviews.insertMany([
  {
    ...
    productId: ObjectId("65f300000000000000000001"),
    user: {
      id: ObjectId("65f000000000000000000002"),
      fullName: "Nguyễn Minh Anh",
    },
    rating: 5,
    comment: "Cây đẹp, lá bóng và đóng gói rất kỹ.",
    isApproved: true,
    createdAt: ISODate("2026-03-12T04:20:00Z"),
  },
  {
    _id: ObjectId("65f800000000000000000002"),
    productId: ObjectId("65f300000000000000000002"),
    user: {
      id: ObjectId("65f000000000000000000003"),
      fullName: "Trần Thu Hà",
    },
    rating: 4,
    comment: "Form cây gọn, hợp bàn làm việc, giao nhanh.",
    isApproved: true,
    createdAt: ISODate("2026-03-11T10:20:00Z"),
  },
  {
    _id: ObjectId("65f800000000000000000003"),
    productId: ObjectId("65f300000000000000000004"),
    user: {
      id: ObjectId("65f000000000000000000004"),
      fullName: "Lê Hoàng Nam",
    },
    rating: 5,
  ...
  },
  {
    ...
    isApproved: true,
    createdAt: ISODate("2026-03-10T11:30:00Z"),
  },
  {
    _id: ObjectId("65f800000000000000000005"),
    productId: ObjectId("65f300000000000000000008"),
    user: {
      id: ObjectId("65f000000000000000000003"),
      fullName: "Trần Thu Hà",
    },
    ...
    isApproved: true,
    createdAt: ISODate("2026-03-12T01:15:00Z"),
  },
]);
...
db.inventory_logs.insertMany([
  {
    _id: ObjectId("65f900000000000000000001"),
    productId: ObjectId("65f300000000000000000001"),
    adminId: ObjectId("65f000000000000000000001"),
    actionType: "import",
    quantityChanged: 20,
    quantityBefore: 14,
    quantityAfter: 34,
    note: "Nhập thêm kim tiền đợt đầu tuần.",
    createdAt: ISODate("2026-03-11T01:00:00Z"),
  },
  {
    _id: ObjectId("65f900000000000000000002"),
    productId: ObjectId("65f300000000000000000002"),
    adminId: ObjectId("65f000000000000000000001"),
    actionType: "export",
    quantityChanged: 3,
    ...
    createdAt: ISODate("2026-03-11T08:30:00Z"),
  },
  {
    _id: ObjectId("65f900000000000000000003"),
    productId: ObjectId("65f300000000000000000004"),
    adminId: ObjectId("65f000000000000000000001"),
  ...
  {
    _id: ObjectId("65f900000000000000000004"),
    productId: ObjectId("65f300000000000000000005"),
    adminId: ObjectId("65f000000000000000000001"),
    actionType: "import",
    quantityChanged: 30,
    ...
    createdAt: ISODate("2026-03-12T02:00:00Z"),
  },
  {
    _id: ObjectId("65f900000000000000000005"),
    productId: ObjectId("65f300000000000000000008"),
    adminId: ObjectId("65f000000000000000000001"),
    actionType: "import",
    quantityChanged: 12,
    ...
    createdAt: ISODate("2026-03-12T03:40:00Z"),
  },
]);
...
db.sales_stats.insertMany([
  ...
  {
    _id: ObjectId("65fa00000000000000000002"),
    statDate: "2026-03-09",
    totalOrders: 8,
  ...
  {
    _id: ObjectId("65fa00000000000000000003"),
    statDate: "2026-03-10",
    totalOrders: 9,
  ...
  {
    _id: ObjectId("65fa00000000000000000004"),
    statDate: "2026-03-11",
    totalOrders: 11,
  ...
  {
    _id: ObjectId("65fa00000000000000000005"),
    statDate: "2026-03-12",
    totalOrders: 7,
...
print("Seed data hoàn tất! Kiểm tra bằng lệnh db.<collection>.find().pretty()");
